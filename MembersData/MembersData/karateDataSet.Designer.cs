...
namespace MembersData.karateDataSetTableAdapters {
...
SELECT ID, Last_Name, First_Name, Phone, Date_Joined FROM Members WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MembersData.Properties.Settings.Default.karateConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        ID, Last_Name, First_Name, Phone, Date_Joined\r\nFROM            Memb" +
                "ers\r\nWHERE        (Date_Joined < @beforeDate)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@beforeDate", global::System.Data.SqlDbType.SmallDateTime, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Joined", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        ID, Last_Name, First_Name, Phone, Date_Joined\r\nFROM            Memb" +
                "ers\r\nWHERE        (Date_Joined > @afterDate)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@afterDate", global::System.Data.SqlDbType.SmallDateTime, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Joined", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int GetMemberBeforeDate(karateDataSet.MembersDataTable dataTable, global::System.Nullable<global::System.DateTime> beforeDate) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((beforeDate.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(beforeDate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int GetMembersAfterDate(karateDataSet.MembersDataTable dataTable, global::System.Nullable<global::System.DateTime> afterDate) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((afterDate.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(afterDate.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
